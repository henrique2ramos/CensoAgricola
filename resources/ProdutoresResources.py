    ...
    def put(self, produtor_id):
        ...
        try:
            ...
            if 'nome_razao_social' in produtor_data:
                produtor.nome_razao_social = produtor_data.get('nome_razao_social')
            if 'documento' in produtor_data or 'cpf' in produtor_data or 'cnpj' in produtor_data:
                produtor.documento = _resolver_documento_produtor(produtor_data, produtor.documento)
            if 'inscricao_estadual' in produtor_data:
                produtor.inscricao_estadual = produtor_data.get('inscricao_estadual')
