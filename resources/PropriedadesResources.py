    ...
    def post(self):
        ...
        try:
            ...
            propriedade = Propriedade(
                ...
                codigo_uf=codigo_uf,
                area_preservacao_ha=propriedade_data.get(
                    'area_preservacao_ha'),
                area_infraestrutura_ha=propriedade_data.get(
    ...
    def put(self, propriedade_id):
        ...
        try:
            ...
            if 'nome_propriedade' in propriedade_data:
                propriedade.nome_propriedade = propriedade_data.get(
                    'nome_propriedade')
            ...
            if 'codigo_municipio' in propriedade_data:
                propriedade.codigo_municipio = propriedade_data.get(
                    'codigo_municipio')
            ...
            if 'area_total_ha' in propriedade_data:
                propriedade.area_total_ha = propriedade_data.get(
                    'area_total_ha')
            if 'area_preservacao_ha' in propriedade_data:
                propriedade.area_preservacao_ha = propriedade_data.get(
                    'area_preservacao_ha')
            if 'area_infraestrutura_ha' in propriedade_data:
                propriedade.area_infraestrutura_ha = propriedade_data.get(
                    'area_infraestrutura_ha')
