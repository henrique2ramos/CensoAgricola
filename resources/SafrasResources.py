    ...
    def post(self):
        ...
        try:
            ...
            safra = Safra(
                ...
                data_colheita_estimada=safra_data.get(
    ...
    def put(self, safra_id):
        ...
        try:
            ...
            if 'data_plantio_estimada' in safra_data:
                safra.data_plantio_estimada = safra_data.get(
                    'data_plantio_estimada')
            if 'data_colheita_estimada' in safra_data:
                safra.data_colheita_estimada = safra_data.get(
                    'data_colheita_estimada')
            if 'expectativa_producao' in safra_data:
                safra.expectativa_producao = safra_data.get(
                    'expectativa_producao')
